...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/showdesigners.cz",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@showdesigners",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/showdesigners",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/showdesigners.cz",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <div className="flex items-center gap-4 mt-6">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="text-white/30 hover:text-[#C8D400] transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
            ...
            <ul className="flex flex-col gap-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/60 text-sm hover:text-[#C8D400] transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li>
                <a
                  ...
                  className="text-[#C8D400] hover:text-[#d9e600] transition-colors duration-200"
                >
